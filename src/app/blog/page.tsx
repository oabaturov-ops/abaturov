                ...
                {filtered.map(a => (
                  <Link key={a.slug} href={`/blog/${a.slug}`} style={{ textDecoration: "none", color: "inherit" }}>
                    <div style={{ padding: "28px", borderRadius: "12px", border: "1px solid #262626", backgroundColor: "#111" }}>
                      <h2 style={{ fontSize: "22px", fontWeight: 600, color: "#fff", margin: "0 0 12px 0" }}>
                        {a.title}
                      </h2>
                      <p style={{ fontSize: "16px", color: "#a3a3a3", lineHeight: 1.6, margin: "0 0 16px 0" }}>
                        {a.excerpt}
                      </p>
                      <div style={{ display: "flex", flexWrap: "wrap", gap: "12px", alignItems: "center", fontSize: "14px", color: "#737373" }}>
                        <span>{a.date}</span>
                        <span style={{ color: "#c9a84c", backgroundColor: "rgba(201,168,76,0.1)", padding: "2px 10px", borderRadius: "999px", fontSize: "12px" }}>
                          {a.category}
                        </span>
